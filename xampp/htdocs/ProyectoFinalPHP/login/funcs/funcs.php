...
function enviarEmail($email, $nombre, $asunto, $cuerpo) {
    ...
    $mail->Username = 'tourister.sa@gmail.com'; //Modificar
    $mail->Password = 'sharondavidtourister'; //Modificar

    $mail->setFrom('tourister.sa@gmail.com', 'Supermercado Aldi'); //Modificar
