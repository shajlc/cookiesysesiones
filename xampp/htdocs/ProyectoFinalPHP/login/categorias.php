            ...
            <div class="container" style="padding : 50px 0px;">
                ...
                if (count($categorias) > 0) {
                    ...
                    foreach ($categorias as $categoria) {
                        ?>
                        <a href="welcome.php?categoria=<?php echo $categoria[0] ?>&busqueda=">
                            <div class="col-md-4 col-xs-12" style="<?php echo ($i % 3 == 0 ? 'clear : left;' : ''); ?>">
                                <img class="col-md-12 col-xs-12" src="imagenes/categorias/<?php echo $categoria[2] ?>" />
                                <p class="col-md-12 col-xs-12"><?php echo $categoria[1] ?></p>
                                <p class="col-md-12 col-xs-12"><?php echo $categoria[3] ?></p>
                            </div>
                        </a>
